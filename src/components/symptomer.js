        ...
        <section className="max-w-6xl mx-auto">
            <div className="grid grid-cols-3 max-w-3xl place-items-center mx-auto mb-10">
                {topIcons.map((feeling, i) => (
                    <div key={i} className="bg-moss w-[100px] h-[100px] lg:w-[150px] lg:h-[150px] flex flex-col items-center justify-evenly rounded-md border-1 text-center border-mainText">
                        <Image
                            ...
                            alt={feeling.heading}
                        />
                        <h4 className="text-sm lg:text-xl font-extralight lg:mt-3">{feeling.heading}</h4>
                    </div>
                ))}
            </div>
