      ...
      <main className="min-h-screen mx-auto">
        ...
        <section className=" bg-[url('/heromobile.jpg')] lg:bg-[url('/sonnenakke.JPEG')] bg-cover bg-no-repeat flex flex-col items-center justify-center h-screen">
          <div className="flex flex-col px-2 md:px-0 text-center font-medium max-w-6xl font-playfair">
            ...
            <Animation
              ...
              duration={0.75}
              delay={0.75}
              className="text-4xl md:text-6xl lg:text-[80px] mt-3 lg:mt-14"
            >
              50 min./950 kr
            </Animation>
            <Animation
              ...
              duration={1}
              delay={1.5}
              className="text-base md:text-2xl mx-5 max-w-2xl md:mx-auto p-5 rounded-md font-inria md:mt-5"
            >
              <p>
              ...
              <p>
                Effektivt mod migræne, sportsskader, stress, angst, traumer,
                smerte, piskesmæld, kold skulder, tennisalbue, kontorskader,
                ryg- og nakkeproblemer, eksem, allergi, astma og
        ...
        <section className="py-20 px-10 bg-gradient-to-l from-accentBg to-mainBg">
          <div className="text-start lg:text-center max-w-6xl mx-auto text-balance mb-10 lg:mb-20 md:text-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
              <span className="text-accentText">Body SDS</span> - Hvad kan det
              gøre for mig?
            </h3>
            <p>
            ...
            <p>
              <a className="font-bold" href="/om-body-sds">
                Læs mere her
              </a>
            </p>
          </div>
        ...
        <section className="mx-auto py-20 bg-[url('/sonnenakke.JPEG')] lg:bg-[url('/reviewsbg.jpg')] bg-no-repeat bg-cover">
          <Animation
            ...
            type="SlideInTop"
            delay={0}
            className="text-start lg:text-center mb-20 max-w-5xl mx-auto px-10"
          >
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-5 back">
              Mine <span className="text-accentText">fantastiske kunder</span>{" "}
              har sagt følgende:
            </h3>
            <p className="text-lg">
        ...
        <section className="py-20 bg-gradient-to-l from-accentBg to-mainBg px-10 b">
          <div className="max-w-6xl flex flex-col lg:flex-row mx-auto justify-between gap-20 ">
            <div className="flex-1 lg:text-start">
              <div className="mb-10">
                ...
                <p className="font-semibold">
                  Ikke alle sessioner er ens, men dette er i helhed hvad BODY
                  SDS står for:
                </p>
              </div>
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <p>
                    Behandleren udfører en fysisk vurdering af klientens krop.
                    Dette kan omfatte observation af kropsholdning, bevægelighed
                    og eventuelle muskelspændinger eller ømheder.
                  </p>
                  <p>
                    Selve behandlingen involverer dybdegående massage og tryk på
                    specifikke punkter på kroppen. Behandleren bruger hænder,
                    albuer og knæ for at løsne spændinger i muskler og led.
                    Massagen kan være intens og dyb, men den tilpasses altid
                    klientens komfortniveau..
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg">Åndedrætsøvelser:</h4>
                  <p>
                    Behandleren guider klienten gennem specifikke
                    åndedrætsøvelser for at fremme afslapning og frigøre indre
                    spændinger. Disse øvelser hjælper med at øge iltoptagelsen
                    og støtte kroppens naturlige helingsprocesser.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg">Afslapning:</h4>
                  <p>
                    Klienten får tid til at hvile og integrere behandlingen,
                    ofte med et par minutters afslapning på briksen.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg">
                    Efterbehandling og rådgivning:
                  </h4>
                  <p>
                    Efter behandlingen diskuterer behandleren og klienten
                    eventuelle observationer og fremtidige skridt.
                  </p>
                  <p>
                    Klienten kan få råd om øvelser eller livsstilsændringer, der
                    kan hjælpe med at opretholde og forbedre
                    behandlingsresultaterne..
                  </p>
                  <p>
                    Under behandlingen kan der også være fokus på sammenhængen
                    mellem krop og psyke. Behandleren kan tale med klienten om
                    følelsesmæssige oplevelser, der kan være relateret til
                    fysiske spændinger. Formålet er at skabe en
                    helhedsorienteret forståelse af klientens velbefindende.
                  </p>
                </div>
                <Animation as="p" type="OnlyAppear" delay={3}>
            ...
            <div className="flex lg:flex-col justify-evenly gap-5">
              <div className="flex items-start relative">
                <Image
                  className="rounded-md z-20 w-[350px] border-2 border-moss"
                  src="/samtale.jpg"
                  width={400}
                  height={400}
