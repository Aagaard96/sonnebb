...
export default function OmBodysds() {
  return (
    <article className="flex gap-20 max-w-5xl mx-auto my-20 px-10">
      <div className="flex-1 flex flex-col text-lg">
        <div className="mb-10">
          <h3 className="text-4xl font-bold leading-none">Hvad er <span className="text-moss">Body SDS?</span></h3>
        </div>
